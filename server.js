...
app.get('/', function(req, res) {
	...
	if(req.query.client_id ==='828225850885-kaka1030svjtfjtjfndpmm13mjkpb2d0.apps.googleusercontent.com' ) {
		...
		res.redirect('https://accounts.google.com/o/oauth2/v2/auth?scope=' + req.query.scope+' &include_granted_scopes=true&access_type=offline&state='+ req.query.state+'&redirect_uri=https://alexa.amazon.co.jp/api/skill/link/M28YSGJKH151MO&response_type=code&client_id='+ req.query.client_id);
	}
